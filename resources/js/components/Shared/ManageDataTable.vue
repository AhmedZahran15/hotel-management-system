...
watch(sorting, (newSorting: SortingValue[]) => {pagination.value.pageIndex = 1;emit('update:sorting', newSorting)}, { deep: true });
    ...
    <div>
                ...
                <TableHeader>
                    <TableRow v-for="headerGroup in table.getHeaderGroups()" :key="headerGroup.id">
                        <TableHead
                            ...
                            :key="header.id"
                            class="cursor-pointer select-none text-center px-4 py-2 transition hover:bg-gray-100"
                            class="cursor-pointer select-none text-center px-4 py-2 transition hover:bg-gray-100"
        ...
        <div class="mt-4 flex flex-wrap justify-center gap-2">
            ...
            <button
                ...
                class="rounded border bg-gray-200 px-3 py-1 hover:bg-gray-300 disabled:opacity-50"
            >
                Prev
            </button>
